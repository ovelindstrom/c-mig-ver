...
public class StatistikBean {
	...
	/**
	 * Hämtar all tillgänglig statistik om mottagna, sända och borttagna
	 * meddelanden. All statistik lagras i bönan och finns tillgängliga via
	 * get-metoderna.
	 */
	...
	/**
	 * Returnerar aktuellt värde för given kanal utifrån lista med
	 * statistikradobjekt.
	...
	/**
	 * Hämtar alla sända meddelanden grupperade per kanal för angivet datum, dsv
	 * under aktuell dag. Skulle dag vara null kommer dagens datum att användas.
	 * 
	...
	/**
	 * Hämtar alla mottagna meddelanden grupperade per kanal för angivet datum, dsv
	 * under aktuell dag.
	...
	/**
	 * Returnerar inskickat datum som en formaterad datumsträng på formen
	 * yyyy-MM-dd. Skulle
	...
	/**
	 * Returnerar inskickad datumsträng som en Date. Skulle datumstängen vara
	 * felaktigt eller
