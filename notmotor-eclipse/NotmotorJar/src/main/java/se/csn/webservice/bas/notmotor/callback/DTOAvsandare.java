...
public class DTOAvsandare  implements Serializable {
    ...
    static {
        typeDesc.setXmlType(new QName("http://webservice.csn.se/bas/notmotor/callback", "DTOAvsandare"));
        ...
        elemField.setXmlName(new QName("http://webservice.csn.se/bas/notmotor/callback", "applikation"));
        ...
        elemField.setXmlName(new QName("http://webservice.csn.se/bas/notmotor/callback", "kategori"));
        elemField.setXmlType(new QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new QName("http://webservice.csn.se/bas/notmotor/callback", "namn"));
        elemField.setXmlType(new QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new QName("http://webservice.csn.se/bas/notmotor/callback", "epostadress"));
        elemField.setXmlType(new QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new QName("http://webservice.csn.se/bas/notmotor/callback", "replyTo"));
        elemField.setXmlType(new QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
