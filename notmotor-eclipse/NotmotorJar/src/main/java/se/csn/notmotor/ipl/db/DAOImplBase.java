...
public abstract class DAOImplBase implements RowToObjectMapper {
    ...
    /**
     * @param Det värde som ska formateras för SQL
     * @return en SQL-formaterad sträng, t.ex. omgiven med '' om sträng. null returneras som "NULL". 
     */
	...
	public static String addRestriction(String where, String colname, String operator, Object value, boolean ignoreNull) {
	    if(value != null) {
	        if(where == null) {
	            where = "";
	        }
	...
	/**
	 * 
	 * @param where Den villkorssträng till vilken det nya LIKE-villkort ska
	 *              adderas (med AND om det redan finns ett villkor)  
	 * @param colname Kolumnnamn i villkoret
	 * @param value Villkorssträngen. Om den är null så skapas inget LIKE-villkor. 
	 * @param surroundWithWildcards Om true så ska villkoret omges med wildcard (%)
	 * 				såvida det inte redan fanns wildcard i början eller slut. 
	 * @return
	 */
