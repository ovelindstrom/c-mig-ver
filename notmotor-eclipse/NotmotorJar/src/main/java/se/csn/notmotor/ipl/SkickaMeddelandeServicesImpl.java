...
/**
 * Implementering av tjänsten för att skicka meddelanden.
 */
public class SkickaMeddelandeServicesImpl extends MeddelandeServicesImplBase implements SkickaMeddelandeServices {
	...
	/**
	 * Metod som kontrollerar om antal sändningar har överskridit en viss gräns,
	 * MAXSANDFORSOK. Sätter status till TEKNISKT_FEL om gränsen överskridits. Max
	 * antal sändningsförsök styrs av parametern MAXSANDFORSOK.
	 * 
