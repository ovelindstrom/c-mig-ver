...
import se.csn.webservice.bas.notmotor.skicka.DTOMeddelandeHandelse;
...
public abstract class ConvertDTO {
	 ...
	 * 
	 * @param dto - intern dto
	 * @return DTONotifieringResultat - webservice dto
	 */
	public static DTONotifieringResultat getNotifieringresultat(NotifieringResultat dto) {
		DTONotifieringResultat nyDto = new DTONotifieringResultat();
		nyDto.setMeddelandeId(dto.getMeddelandeId());
		nyDto.setResultat(dto.getResultat());
		nyDto.setInfo(dto.getInfo());
	 ...
	 * 
	 * @param dto - webservice dto
	 * @return DTONotifieringResultat - intern dto
	 */
	public static NotifieringResultat getNotifieringresultat2(DTONotifieringResultat dto) {
		NotifieringResultat nyDto = new NotifieringResultat();
		nyDto.setMeddelandeId(dto.getMeddelandeId());
		nyDto.setResultat(dto.getResultat());
		nyDto.setInfo(dto.getInfo());
